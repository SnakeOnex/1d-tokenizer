...
def calculate_fvd(videos1, videos2, i3d, device, method='styleganv', only_final=False):
    ...
    if only_final:
        ...
        assert videos1.shape[2] >= 10, f"for calculate FVD, each clip_timestamp must >= 10, {videos1.shape}"
